...
<body>
    ...
    <div class="container mt-5 pt-5">
        <section id="welcome" class="text-center my-5">
        ...
        <section id="purpose" class="my-5">
            ...
            <p>Website ini dibuat untuk mempermudah akses mencatat dan merekap sumbangan Jumat Beramal yang diadakan sekolah</p>
            <p>Website ini dibuat sesuai dengan kebutuhan dan ketentuan yang berlaku disekolah.</p>
        </section>
    ...
    <div class="pembuat-container">
        <div class="pembuat">
            ...
            <h3>Nama : Muhammad Afifuddin Muchtar</h3>
            <p>Kelas : XII PPLG 2</p>
            <p>Tahun ajaran : 2022 - 2025</p>
        </div>
        <div class="pembuat">
            <img src="images/pembuat2.jpg" alt="Pembuat 2">
            <h3>Nama : Muhammad Adidtya Putra Ramadhan</h3>
            <p>Kelas : XII PPLG 2</p>
            <p>Tahun Ajaran: 2022 - 2025</p>
        </div>
    </div>
